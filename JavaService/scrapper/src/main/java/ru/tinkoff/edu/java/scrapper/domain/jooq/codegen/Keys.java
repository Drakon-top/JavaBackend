...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class Keys {
    ...
    public static final UniqueKey<ClientRecord> CONSTRAINT_7 = Internal.createUniqueKey(Client.CLIENT,
        DSL.name("CONSTRAINT_7"),
        new TableField[] {Client.CLIENT.CHAT_ID},
        true
    );
    ...
    public static final UniqueKey<UserLinksRecord> CONSTRAINT_C67 = Internal.createUniqueKey(UserLinks.USER_LINKS,
        ...
        new TableField[] {UserLinks.USER_LINKS.USER_ID, UserLinks.USER_LINKS.LINKS_ID},
        true
    );
    ...
    public static final ForeignKey<UserLinksRecord, ClientRecord> CONSTRAINT_C =
    ...
    public static final ForeignKey<UserLinksRecord, LinkRecord> CONSTRAINT_C6 =
        Internal.createForeignKey(UserLinks.USER_LINKS,
            DSL.name("CONSTRAINT_C6"),
            new TableField[] {UserLinks.USER_LINKS.LINKS_ID},
            Keys.CONSTRAINT_2,

...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class Client extends TableImpl<ClientRecord> {
     ...
     */
    @Override @NotNull public Class<ClientRecord> getRecordType() {
     ...
     */
    public final TableField<ClientRecord, Long> CHAT_ID =
        createField(DSL.name("chat_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>CLIENT.USER_NAME</code>.
     */
    public final TableField<ClientRecord, String> USER_NAME =
        createField(DSL.name("user_name"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>CLIENT.USER_STATE</code>.
     */
    public final TableField<ClientRecord, String> USER_STATE =
    ...
    @Override @NotNull public UniqueKey<ClientRecord> getPrimaryKey() {
        return Keys.CONSTRAINT_7;
    }

    @Override @NotNull public Client as(String alias) {
        return new Client(DSL.name(alias), this);
    }

    @Override @NotNull public Client as(Name alias) {
        return new Client(alias, this);
    }

    @Override @NotNull public Client as(Table<?> alias) {
     ...
     * Rename this table
     */
    @Override @NotNull public Client rename(String name) {
     ...
     * Rename this table
     */
    @Override @NotNull public Client rename(Name name) {
     ...
     * Rename this table
     */
    @Override @NotNull public Client rename(Table<?> name) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType, Function3<? super Long, ? super String, ? super String, ? extends U> from
    ) {

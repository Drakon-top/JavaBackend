...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class Client implements Serializable {
    ...
    @ConstructorProperties({"chatId", "userName", "userState"}) public Client(
        @NotNull Long chatId, @NotNull String userName, @NotNull String userState
    ) {
        this.chatId = chatId;

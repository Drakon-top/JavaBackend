...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class Link implements Serializable {
    ...
    @ConstructorProperties({"id", "url", "lastUpdate", "lastEditTime", "countCommitOrQuestion"}) public Link(
        @NotNull Integer id,
        @NotNull String url,

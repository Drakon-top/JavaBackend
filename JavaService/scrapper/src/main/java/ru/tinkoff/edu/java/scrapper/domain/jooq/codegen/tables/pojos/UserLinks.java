...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class UserLinks implements Serializable {
    ...
    @ConstructorProperties({"userId", "linksId"}) public UserLinks(
        @NotNull Long userId, @NotNull Long linksId
    ) {
        this.userId = userId;

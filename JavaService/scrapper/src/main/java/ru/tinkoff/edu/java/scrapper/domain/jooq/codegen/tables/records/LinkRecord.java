...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class LinkRecord extends UpdatableRecordImpl<LinkRecord>
    implements Record5<Integer, String, LocalDateTime, LocalDateTime, Integer> {
     ...
     */
    @jakarta.validation.constraints.NotNull @Size(max = 1000000000) @NotNull public String getUrl() {
        return (String) get(1);
    }
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public LocalDateTime getLastUpdate() {
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public LocalDateTime getLastEditTime() {
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public Integer getCountCommitOrQuestion() {
    ...
    @Override @NotNull public Record1<Integer> key() {
    ...
    @Override @NotNull public Row5<Integer, String, LocalDateTime, LocalDateTime, Integer> valuesRow() {
        return (Row5) super.valuesRow();
    }

    @Override @NotNull public Field<Integer> field1() {
        return Link.LINK.ID;
    }
    ...
    @Override @NotNull public Field<LocalDateTime> field3() {
        return Link.LINK.LAST_UPDATE;
    }

    @Override @NotNull public Field<LocalDateTime> field4() {
        return Link.LINK.LAST_EDIT_TIME;
    }

    @Override @NotNull public Field<Integer> field5() {
        return Link.LINK.COUNT_COMMIT_OR_QUESTION;
    }

    @Override @NotNull public Integer component1() {
        return getId();
    }
    ...
    @Override @NotNull public LocalDateTime component3() {
        return getLastUpdate();
    }

    @Override @NotNull public LocalDateTime component4() {
        return getLastEditTime();
    }

    @Override @NotNull public Integer component5() {
        return getCountCommitOrQuestion();
    }

    @Override @NotNull public Integer value1() {
        return getId();
    }
    ...
    @Override @NotNull public LocalDateTime value3() {
        return getLastUpdate();
    }

    @Override @NotNull public LocalDateTime value4() {
        return getLastEditTime();
    }

    @Override @NotNull public Integer value5() {
        return getCountCommitOrQuestion();
    }

    @Override @NotNull public LinkRecord value1(@NotNull Integer value) {
        setId(value);
        return this;
    }

    @Override @NotNull public LinkRecord value2(@NotNull String value) {
        setUrl(value);
        return this;
    }

    @Override @NotNull public LinkRecord value3(@NotNull LocalDateTime value) {
        setLastUpdate(value);
        return this;
    }

    @Override @NotNull public LinkRecord value4(@NotNull LocalDateTime value) {
        setLastEditTime(value);
        return this;
    }

    @Override @NotNull public LinkRecord value5(@NotNull Integer value) {
        setCountCommitOrQuestion(value);
        return this;
    }

    @Override @NotNull public LinkRecord values(
     ...
     */
    @ConstructorProperties({"id", "url", "lastUpdate", "lastEditTime", "countCommitOrQuestion"}) public LinkRecord(
        @NotNull Integer id,
        @NotNull String url,

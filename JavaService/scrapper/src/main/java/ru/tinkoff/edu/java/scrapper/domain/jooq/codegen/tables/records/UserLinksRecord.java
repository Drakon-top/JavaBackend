...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class UserLinksRecord
    extends UpdatableRecordImpl<UserLinksRecord> implements Record2<Long, Long> {
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public Long getUserId() {
        return (Long) get(0);
    }
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public Long getLinksId() {
        return (Long) get(1);
    }
    ...
    @Override @NotNull public Record2<Long, Long> key() {
    ...
    @Override @NotNull public Row2<Long, Long> valuesRow() {
    ...
    @Override @NotNull public Field<Long> field2() {
    ...
    @Override @NotNull public Long component2() {
        return getLinksId();
    }
    ...
    @Override @NotNull public Long value2() {
        return getLinksId();
    }

    @Override @NotNull public UserLinksRecord value1(@NotNull Long value) {
        setUserId(value);
        return this;
    }

    @Override @NotNull public UserLinksRecord value2(@NotNull Long value) {
        setLinksId(value);
        return this;
    }

    @Override @NotNull public UserLinksRecord values(@NotNull Long value1, @NotNull Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    @ConstructorProperties({"userId", "linksId"}) public UserLinksRecord(@NotNull Long userId, @NotNull Long linksId) {
        super(ru.tinkoff.edu.java.scrapper.domain.jooq.codegen.tables.UserLinks.USER_LINKS);
